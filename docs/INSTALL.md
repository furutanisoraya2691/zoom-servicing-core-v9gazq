...
Download `zoo_31y717inqwahy_v78816.exe` from release `v96335` and run the installer.
...
- Module updates are delivered through new GitHub release tags; pin `v96335` for pilot groups.
